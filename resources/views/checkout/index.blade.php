                        ...
                        @else
                            @foreach ($cart as $product)
                                <div class="row align-items-center mb-2">
                                     <div class="col-md-3">
                                        <a href="{{ route('shops.show', $product->id) }}">
                                            @if ($product->options->image)
                                                <img src="{{ asset($shop->options->image) }}" class="img-thumbnail">
                                            @else
                                    ...
                                    <div class="col-md-9">
                                        <div class="flex-column">
                                           <p class="fs-5 mb-2">
                                               <a href="{{ route('shops.show', $product->id) }}" class="link-dark text-decoration-none">{{ $shop->name }}</a>
                                            </p>
                                            <div class="row mb-2">
                                                <div class="col-xxl-3">
